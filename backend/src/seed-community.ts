...
async function seedCommunityUsers() {
  ...
  const noseNotes = [
    ...
    'Peat smoke, sea salt, citrus',
    'Dried fruit, sherry, oak',
    'Fresh apple, malt, floral',
    'Toffee, cinnamon, butterscotch',
  ];
  const palateNotes = [
    'Rich oak, dark chocolate, cherry',
    'Smoky brine, pepper, dark fruit',
    'Orange peel, ginger, walnut',
    'Honey, vanilla, spiced pear',
    'Corn sweetness, leather, tobacco',
  ];
  const finishNotes = [
    'Long warm finish with lingering spice',
    'Clean campfire fade',
    'Elegant and lasting with dried fruit',
    'Medium finish with caramel sweetness',
    'Bold, slow fade with dark chocolate',
  ];
