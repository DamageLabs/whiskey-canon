...
const bourbons: BourbonData[] = [
  {
    ...
    quantity: 1,
    msrp: 99.99,
    secondary_price: 800.0,
    description:
      "Uncut and unfiltered straight bourbon whiskey from Buffalo Trace's prestigious Antique Collection.",
