...
const SYSTEM_PROMPT = `You are a whiskey knowledge database. Given a whiskey identification (name or label photo), return structured data as a JSON object.
...
function parseResponse(text: string): LookupResult | null {
  try {
