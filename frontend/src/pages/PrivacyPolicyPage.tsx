            ...
            <div className="card shadow-sm">
              <div className="card-body p-5">
                ...
                <section className="mb-4">
                  ...
                  <p>
                    Welcome to Whiskey Canon ("we," "our," or "us"). We are committed to protecting
                    your personal information and your right to privacy. This Privacy Policy
                    explains how we collect, use, disclose, and safeguard your information when you
                    use our whiskey collection management application.
                  </p>
                </section>
                ...
                <section className="mb-4">
                  ...
                  <p>
                    We collect the following personal information when you register and use our
                    service:
                  </p>
                  <ul>
                    <li>
                      <strong>Account Information:</strong> Username, email address, password
                      (encrypted), first name, and last name
                    </li>
                    <li>
                      <strong>Profile Information:</strong> Optional profile photo and any
                      additional details you choose to provide
                    </li>
                    <li>
                      <strong>Collection Data:</strong> Information about whiskeys in your
                      collection, including names, types, ratings, tasting notes, and purchase
                      details
                    </li>
                  </ul>
                  ...
                  <ul>
                    ...
                    <li>
                      <strong>Cookies:</strong> Session cookies for authentication and user
                      experience
                    </li>
                  </ul>
                </section>
                ...
                <section className="mb-4">
                  ...
                  <ul>
                    ...
                    <li>
                      <strong>Legal Requirements:</strong> If required by law or to respond to legal
                      process
                    </li>
                    <li>
                      <strong>Protection of Rights:</strong> To protect the rights, property, or
                      safety of Whiskey Canon, our users, or others
                    </li>
                    <li>
                ...
                <section className="mb-4">
                  ...
                  <ul>
                    ...
                    <li>
                      <strong>Export:</strong> Export your collection data in CSV format
                    </li>
                    <li>
                  ...
                  <p>
                    To exercise these rights, please contact us or use the available tools in your
                    account settings.
                  </p>
                </section>
                ...
                <section className="mb-4">
                  ...
                  <ul>
                    <li>
                      <strong>Session Cookies:</strong> Essential for authentication and maintaining
                ...
                <section className="mb-4">
                  ...
                  <p>
                    ...
                    needed to provide our services. If you request account deletion, we will remove
                    your data within 30 days, except where we are required to retain it for legal or
                    regulatory purposes.
                  </p>
                </section>
                ...
                <section className="mb-4">
                  ...
                  <p>
                    Our service is not intended for individuals under the age of 21 (the legal
                    drinking age in the United States). We do not knowingly collect personal
                    information from individuals under 21. If we become aware that we have collected
                ...
                <section className="mb-4">
                  ...
                  <p>
                    ...
                    States where our servers are located. By using our service, you consent to this
                    transfer.
                  </p>
                </section>
                ...
                <section className="mb-4">
                  ...
                  <ul className="list-unstyled">
                    <li>
                      <strong>Email:</strong> privacy@whiskeycanon.com
                    </li>
                    <li>
                      <strong>Address:</strong> Whiskey Canon, Privacy Department
                    </li>
                  </ul>
                </section>
              </div>
